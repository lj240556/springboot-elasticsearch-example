...
public class TermQueryService {
    ...
    public Object termQuery() {
        ...
        try {
            ...
            searchSourceBuilder.query(QueryBuilders.termQuery("address.keyword", "北京市通州区"));//这里的意思是address.keyword包含 北京市通州区的值。
            // 创建查询请求对象，将查询对象配置到其中
    ...
    public Object termsQuery() {
        ...
        try {
            ...
            searchSourceBuilder.query(QueryBuilders.termsQuery("address.keyword", "北京市丰台区", "北京市昌平区", "北京市大兴区")); //address.keyword  keyword表示必须精确匹配在三个里面的一个 相当于一个范围
